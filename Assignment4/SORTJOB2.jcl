...
//SYSOUT   DD SYSOUT=*
//SORTIN   DD DSN=Z67419.JCL.SORTIN3,DISP=SHR
//SORTOUT  DD DSN=Z67419.JCL.SORTOUT3,DISP=OLD
//SYSIN    DD *
...
//TOOLMSG  DD SYSOUT=*
//DFSMSG   DD SYSOUT=*
//IN1      DD DSN=Z67419.JCL.SORTIN3,DISP=SHR
//TOOLIN   DD *
